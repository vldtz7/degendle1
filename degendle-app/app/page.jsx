      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <footer style={{ marginTop: '60px', paddingTop: '20px', fontSize: '0.78rem', color: '#8aa8a3' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '20px', marginTop: '25px', fontSize: '1.04rem' }}>
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" style={{ color: '#2d4a47', textDecoration: 'none' }}>
              [ twitter ]
            </a>
            <a href="https://discord.com" target="_blank" rel="noopener noreferrer" style={{ color: '#2d4a47', textDecoration: 'none' }}>
              [ discord ]
            </a>
            <a href="https://telegram.org" target="_blank" rel="noopener noreferrer" style={{ color: '#2d4a47', textDecoration: 'none' }}>
              [ telegram ]
            </a>
          </div>
